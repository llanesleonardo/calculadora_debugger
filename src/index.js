import { getResults as logic } from './logic'
...
function main(operations, numbers, equal, reset, result) {
  // Notes:
  ...
  operations.forEach(operation =>
    operation.addEventListener('click', e => {
      ...
      operation1 = e.target.innerText
      let operation = OPERATIONS[e.target.innerText]
  ...
  equal.addEventListener('click', () => {
    result.innerText = logic(first, second, operation1)
  })
...
main(operations, numbers, equal, reset, result)
